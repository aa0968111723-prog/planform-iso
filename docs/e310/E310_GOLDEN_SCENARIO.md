...
> 2026-08-24 Release 補充：照片全量盤點後，正式**視覺 Golden** 已改為
> **「E310 禪學社社課（30 人）」**。30 人版本不設入口收費桌或走廊排隊鏈；
> 流程為入門 → 教室內報到 → 右側鞋區 → 課桌椅背包區 → 後側通道 → 巧拼後緣。
> 下列 60 人範例保留為 simulation 壓力測試與歷史規格，不再代表照片中的主要場景。
