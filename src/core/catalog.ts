...
export const BUILTIN_CATALOG: AssetCatalogEntry[] = [
  ...
  },
  {
    ...
    category: "equipment",
    placementType: "floor",
    dimensions: { width: 0.8, depth: 0.5, height: 0.74 },
    defaultFacingDeg: 0,
    clearanceFront: 0.4,
    blocksFlow: true,
    serviceRole: "none",
    ...
    icon: "🎛",
    color: "#0e7490",
    visualRef: "proc:table",
    planSymbolRef: "plan:table",
    tags: ["equipment", "av", "staff"],
    createdBy: "builtin",
    version: 1,
    allowCustomSize: true,
    presets: [preset("av8050", 0.8, 0.5, 0.74)],
  },
  {
    id: "builtin:ppt-control",
    name: "控 PPT",
    semanticType: "computer",
    sourceType: "builtin-procedural",
    category: "equipment",
    placementType: "floor",
    dimensions: { width: 0.6, depth: 0.45, height: 0.74 },
    defaultFacingDeg: 0,
    clearanceFront: 0.4,
    blocksFlow: true,
    serviceRole: "none",
    ...
    icon: "🖥",
    color: "#7c3aed",
    visualRef: "proc:computer",
    planSymbolRef: "plan:computer",
    tags: ["equipment", "ppt", "staff"],
    createdBy: "builtin",
    version: 1,
    allowCustomSize: true,
    presets: [preset("ppt6045", 0.6, 0.45, 0.74)],
  },
  {
    id: "builtin:name-badge-box",
    name: "名牌盒",
    semanticType: "other",
    sourceType: "builtin-procedural",
    category: "equipment",
    placementType: "tabletop",
    dimensions: { width: 0.28, depth: 0.2, height: 0.12 },
    defaultFacingDeg: 0,
    clearanceFront: 0,
    blocksFlow: false,
    serviceRole: "checkin",
    ...
    visualRef: "proc:payment-box",
    planSymbolRef: "plan:payment-box",
    tags: ["equipment", "checkin", "badge"],
    createdBy: "builtin",
    version: 1,
    allowCustomSize: true,
    presets: [preset("nb", 0.28, 0.2, 0.12)],
    allowedParents: ["table", "regTable"],
    defaultElevation: 0.74,
  },
];
